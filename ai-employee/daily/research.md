...
*Generated: Wednesday 2026-08-19, 12:45 EAT — LIVE research run*
*Topics pulled from research-queue.md. All facts cited; gaps flagged honestly.*

---

## ⛏️ Topic 1: Barrick Gold (now Barrick Mining Corp)

### Overview
Toronto-listed gold and copper major (NYSE: GOLD, TSX: ABX). Rebranded to **Barrick Mining Corp** in late 2025 to reflect its growing copper ambitions. Gold ≈70% of EBITDA; copper ≈30% and growing fast.

### Why It Matters to Us
Two large copper projects coming online: **Lumwana** (Zambia, $2B "Super Pit" expansion — first production expected **March 2028**, doubling output to ~240 Kt/year) and **Reko Diq** (Pakistan, world-class). Offtake needs at scale. Guidance for 2026 copper: **190–220 Kt**, with Q1 2026 already at **49 Kt**. Company target: double copper to 1B lbs by 2031.

### 3 Things Worth Knowing Before Engaging
1. **Lumwana is the lead asset.** Proven & probable reserves: 1.6 Bt @ 0.52% Cu = **8.3 Mt contained copper**. Expansion includes a 52 Mtpa processing plant and new power framework with ZESCO ([miningbeacon.com](https://miningbeacon.com/industry/barricks-lumwana-a-growing-force-in-african-copper), [mining.com](https://www.mining.com/barrick-to-invest-2-billion-in-zambia-copper-mine-expansion/)).
2. **Leadership transition.** **Mark Bristow** resigned Sep 2025; **Mark Hill** formally appointed CEO **Feb 5, 2026** ([BPAS](https://markets.financialcontent.com/bpas/article/finterra-2026-3-23-barrick-mining-20-a-deep-dive-into-the-gold-and-copper-powerhouse-of-2026)).
3. **Offtake window opens ~2027.** New production arrives from March 2028 — contracting conversations likely happening now (≈12–18 months ahead of first concentrate). Q1 2026 results confirmed capex tracking at the low end of $750–850M guidance ([Barrick Q1 2026 PDF](https://s25.q4cdn.com/322814910/files/doc_presentations/2026/Barrick_Q1_2026_Results_Presentation.pdf)).

### Sources
- [Barrick Q1 2026 Results Presentation (PDF)](https://s25.q4cdn.com/322814910/files/doc_presentations/2026/Barrick_Q1_2026_Results_Presentation.pdf)
- [MINING.COM — Barrick to invest $2B in Zambia copper mine expansion](https://www.mining.com/barrick-to-invest-2-billion-in-zambia-copper-mine-expansion/)
- [Mining Beacon — Barrick's Lumwana a 'growing force in African copper'](https://miningbeacon.com/industry/barricks-lumwana-a-growing-force-in-african-copper)
- [BPAS — Barrick Mining 2.0: Deep-Dive into Gold and Copper Powerhouse of 2026](https://markets.financialcontent.com/bpas/article/finterra-2026-3-23-barrick-mining-20-a-deep-dive-into-the-gold-and-copper-powerhouse-of-2026)

### ⚠️ Uncertainties / Gaps
- Specific offtake counterparties for Lumwana / Reko Diq **not disclosed** in the materials I could verify — flag back to the boss.
- Procurement contact paths (CFO office, supply chain, sustainability lead) need LinkedIn / annual report cross-reference.
- Reko Diq production timeline not in the excerpts I retrieved — likely needs separate deep-dive.

---

## ⛏️ Topic 2: Glencore — Cobalt Supply Contracts 2026

### Overview
Swiss-based major (Baar), one of the world's largest diversified miners and commodity traders. **The only major Western producer of copper and cobalt in the DRC** (per CEO Gary Nagle). Active cobalt: Murrin Murrin (Australia), Mutanda Mining (DRC), Kamoto Copper Company (DRC).

### Why It Matters to Us
Glencore is both a **competitor (production)** and a **counterparty (offtake / trader)** in the cobalt market. Their contract strategy gives us a read on benchmark pricing, contract structure, and which end-buyers (OEMs, battery makers) are active.

### 3 Things Worth Knowing Before Engaging
1. **GM multi-year cobalt offtake — Murrin Murrin.** Announced **April 12, 2022**, multi-year sourcing agreement, cobalt goes into GM's Ultium battery cathodes. Counterparty on Glencore side: **Ash Lazenby, US Cobalt Marketer & Trader** ([Glencore press release](https://www.glencore.com/media-and-insights/news/glencore-and-glencore-enter-multi-year-cobalt-supply-agreement), [GM investor](https://investor.gm.com/news-releases/news-release-details/gm-and-glencore-enter-multi-year-cobalt-supply-agreement)). This is the template for cobalt offtake contracts.
2. **DRC consolidation — $9B US-backed consortium deal.** **February 2026**: the Orion Critical Mineral Consortium took a **40% stake in Mutanda Mining and Kamoto Copper Company** — board representation rights and production allocation authority. Glencore retains operational management ([Discovery Alert](https://discoveryalert.com.au/strategic-mineral-acquisition-networks-2026-mining-investment/)). Implications: less Chinese-dominated supply available, more Western-aligned offtake competition.
3. **DRC concentration = leverage.** DRC produces **~70% of global cobalt**. Non-substitutable for EV batteries at scale — premium pricing power. Strategic buyers (governments, OEMs) are actively securing offtake.

### Sources
- [Glencore — Glencore and General Motors enter multi-year cobalt supply agreement](https://www.glencore.com/media-and-insights/news/glencore-and-glencore-enter-multi-year-cobalt-supply-agreement)
- [GM Investor Relations — GM and Glencore Enter Multi-Year Cobalt Supply Agreement](https://investor.gm.com/news-releases/news-release-details/gm-and-glencore-enter-multi-year-cobalt-supply-agreement)
- [Discovery Alert — U.S.-Backed Glencore Deal Transforms Critical Minerals Investment](https://discoveryalert.com.au/strategic-mineral-acquisition-networks-2026-mining-investment/)

### ⚠️ Uncertainties / Gaps
- **Volume, grade, and pricing terms of GM–Glencore contract are not public** — only the multi-year structure is confirmed.
- 2026 spot vs contract cobalt pricing not in retrieved excerpts — cross-check LME / Fastmarkets / Benchmark Mineral Intelligence for current pricing.
- Whether Glencore is still actively seeking new offtake partners (vs fully contracted) needs a recent inquiry or trade-press scan.

---

## ⛏️ Topic 3: Sovereign Wealth Fund Mining Portfolio (PIC, ADIA, GIC)

### Overview
Mixed picture — sovereign capital is flowing into mining / critical minerals at scale in 2026. PIC and GIC specifics were thin in what I could verify; ADIA and the new Canada Strong Fund are well-documented.

### Why It Matters to Us
SWFs are the **long-duration capital** that underwrites multi-decade mine supply. If you can position as the supply partner of an SWF-backed mine / offtake, you get a stable, multi-year relationship — not a spot trade.

### 3 Things Worth Knowing Before Engaging

#### 1. **ADIA (Abu Dhabi)** — ~$870B–$1.1T
- Mining exposure primarily via **private equity LP relationships** (Blackstone, KKR, Apollo, Carlyle) and direct co-investments.
- Strategic sector focus: defense, semiconductors, **renewable energy**, technology. Mining is a slice of alternatives (~20–30% of portfolio).
- ADIA is **deliberately opaque** — specific mining holdings are not disclosed publicly ([Middle East Insider — ADIA, Mubadala, ADQ](https://themiddleeastinsider.com/2026/03/26/adia-mubadala-adq-abu-dhabi-sovereign-wealth-funds-2026/), [ADIA Portfolio 2026](https://themiddleeastinsider.com/2026/04/20/adia-portfolio-2026-abu-dhabi-investment-authority/)).

#### 2. **Canada Strong Fund** — **C$25B, announced Apr 27, 2026**
- First Canadian SWF; direct **equity positions** in mining, critical minerals, energy, advanced manufacturing.
- Priority commodities: **nickel, cobalt, copper, graphite, tungsten, rare earth elements**.
- Returns recycled to compound the fund. Open to Canadian investor participation ([Discovery Alert — Canada SWF](https://discoveryalert.com.au/canada-sovereign-wealth-fund-mining-critical-minerals-2026/), [Canadian Mining Report](https://www.canadianminingreport.com/blog/how-canada-s-sovereign-wealth-fund-could-reshape-the-mining-industry)).

#### 3. **PIC (Public Investment Corporation, South Africa)** and **GIC (Singapore)**
- **No specific mining-portfolio disclosures verified** in this run — flagged as gaps. PIC manages ~R2.5T+ but detailed mining allocations not in retrieved sources; GIC publishes aggregate asset-class splits only.
- **Action:** pull PIC's most recent integrated annual report and GIC's annual report directly to confirm specific mining exposure.

### Sources
- [Discovery Alert — Canada's New Sovereign Wealth Fund Reshaping Mining Investment](https://discoveryalert.com.au/canada-sovereign-wealth-fund-mining-critical-minerals-2026/)
- [Canadian Mining Report — How Canada's Sovereign Wealth Fund Could Reshape the Mining Industry](https://www.canadianminingreport.com/blog/how-canada-s-sovereign-wealth-fund-could-reshape-the-mining-industry)
- [Middle East Insider — ADIA, Mubadala, ADQ: Abu Dhabi's $1.7T SWF Empire Explained](https://themiddleeastinsider.com/2026/03/26/adia-mubadala-adq-abu-dhabi-sovereign-wealth-funds-2026/)
- [Middle East Insider — ADIA Portfolio 2026: Inside Abu Dhabi's $870B Fund](https://themiddleeastinsider.com/2026/04/20/adia-portfolio-2026-abu-dhabi-investment-authority/)

### ⚠️ Uncertainties / Gaps
- **PIC and GIC specific mining exposure** — not verified. Need direct annual report pulls.
- **Saudi PIF ($925B) mining focus** — Vision 2030-aligned; not deep-dived here, recommend a separate topic.
- **Indonesia Danantara ($20B)** — nickel, bauxite, copper processing; relevant if your portfolio includes battery-grade nickel ([Mining.com](https://www.mining.com/web/new-indonesia-sovereign-wealth-fund-to-invest-20-billion-in-projects/)).

---

## Suggested next actions *(for your review — drafts only)*

| Action | Owner |
|--------|-------|
| Cold outreach to Barrick procurement (Mark Hill's office) — copper supply, 2027 offtake window | `daily/inbox.md` draft |
| Inquiry to Glencore cobalt trading desk (Ash Lazenby / Gary Nagle's office) — benchmark contract terms | `daily/inbox.md` draft |
| Research PIC + GIC mining exposure directly (pull annual reports) | `research-queue.md` add |
